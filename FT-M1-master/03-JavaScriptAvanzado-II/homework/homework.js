...
(tip: usá un objeto donde cada propiedad sea el argumento, y su valor el resultado de
     la correspondiente invocación a cb) de manera que, la próxima vez que reciba el 
     mismo argumento, no sea necesario volver a invocar a cb, 
...
*/
    ...
    return function(arg) {
        ...
        if (cache.hasOwnProperty(arg)) {
            return cache[arg]; //ojo no es cache.arg  ya que arg no existe como propiedad
        } else {
            cache[arg] = cb(arg);
            return cache[arg];
        }
